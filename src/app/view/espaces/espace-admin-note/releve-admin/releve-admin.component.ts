...
@Component({
  selector: 'app-releve-admin',
  templateUrl: './releve-admin.component.html',
  styleUrls: ['./releve-admin.component.scss']
})
export class ReleveAdminComponent implements OnInit {
  semestres:any[];
  input1;
  input2;
  ...
  afficherPV(input1:string, input2:number) {
    this.noteEtudiantSemestreService.afficherPVPourA(input1,input2);
